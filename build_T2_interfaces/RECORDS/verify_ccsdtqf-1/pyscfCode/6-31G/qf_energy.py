...
def factorized_quads_Energy(t2,t3,l2,g,o,v):
    ...
    energy +=  0.125000000000000 * einsum('mdkl,ijba,kldc,cbaijm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	 -0.5000 <m,d||j,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(c,b,a,i,k,m)
    energy += -0.500000000000000 * einsum('mdjl,ijba,kldc,cbaikm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	  0.1250 <m,d||i,j>*l2(i,j,b,a)*l2(k,l,d,c)*t3(c,b,a,k,l,m)
    energy +=  0.125000000000000 * einsum('mdij,ijba,kldc,cbaklm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
    
    #	  0.1250 <m,b||k,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(d,c,a,i,j,m)
    energy +=  0.125000000000000 * einsum('mbkl,ijba,kldc,dcaijm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	 -0.5000 <m,b||j,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(d,c,a,i,k,m)
    energy += -0.500000000000000 * einsum('mbjl,ijba,kldc,dcaikm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
    
    #	  0.1250 <m,b||i,j>*l2(i,j,b,a)*l2(k,l,d,c)*t3(d,c,a,k,l,m)
    energy +=  0.125000000000000 * einsum('mbij,ijba,kldc,dcaklm', g[o, v, o, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
    
    #	  0.1250 <d,c||e,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,b,a,i,j,k)
    energy +=  0.125000000000000 * einsum('dcel,ijba,kldc,ebaijk', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	  0.1250 <d,c||e,j>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,b,a,i,k,l)
    energy +=  0.125000000000000 * einsum('dcej,ijba,kldc,ebaikl', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	 -0.5000 <d,b||e,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,c,a,i,j,k)
    energy += -0.500000000000000 * einsum('dbel,ijba,kldc,ecaijk', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 2), (0, 1), (0, 1)])
    
    #	 -0.5000 <d,b||e,j>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,c,a,i,k,l)
    energy += -0.500000000000000 * einsum('dbej,ijba,kldc,ecaikl', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
    
    #	  0.1250 <b,a||e,l>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,d,c,i,j,k)
    energy +=  0.125000000000000 * einsum('bael,ijba,kldc,edcijk', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
    
    #	  0.1250 <b,a||e,j>*l2(i,j,b,a)*l2(k,l,d,c)*t3(e,d,c,i,k,l)
    energy +=  0.125000000000000 * einsum('baej,ijba,kldc,edcikl', g[v, v, v, o], l2, l2, t3, optimize=['einsum_path', (0, 1), (0, 1), (0, 1)])
