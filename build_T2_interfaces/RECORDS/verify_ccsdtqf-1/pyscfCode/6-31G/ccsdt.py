...
def doubles_residual(t1, t2, t3, f, g, o, v,e_ijab):
    ...
    import modify_T2resid_throughT4 as thruT4
    l2f=np.zeros((nsvirt, nsvirt, nsocc, nsocc))
    l2f=t2 #g[v,v,o,o]*e_ijab
    l2=l2f.transpose(2,3,0,1)
    
    fourthO_doubleRes=thruT4.fourthOrder(o,v,g,l2,t2,t3)
    doubles_res += 0.5*fourthO_doubleRes
...
def main():
    ...
    print("")
    print(flush=True)
    #import qf_energy as fact_qf_e
    import qf_test as fact_qf_e

    l2=t2f.transpose(2,3,0,1)
    t2_dag=g[v,v,o,o]*e_abij
    t2_dagger=t2_dag.transpose(2,3,0,1)
    qf_e=fact_qf_e.factorized_quads_Energy(t2f,t2_dagger,t3f,l2,g,o,v) 
