...
import Get_T4_corrections_ccsdtQf as Qf
...
def doubles_residual(t1, t2, t3, f, g, o, v, e_ijab,t4):
    """
...
# Add R2(WnT4)|0> to T2 residual eqns
    # create: resid_t4, t4_doubles_res data-structure
    # Add denominator to function call D2, figure out how to call get_t4 w/ modified t2f?
    #         0.2500 <l,k||c,d>*t4(c,d,a,b,i,j,l,k)


    t4_doubles_res = np.zeros((nsvirt, nsvirt,nsocc, nsocc))
    t4_doubles_res = np.zeros((nsvirt, nsvirt, nsocc, nsocc))
    t4_doubles_res =  0.250000000000000 * einsum('lkcd,cdabijlk->abij', g[o, o, v, v], t4[:, :, :, :, :, :, :, :])
    

    doubles_res+= e_ijab*t4_doubles_res
...
def kernel(t1, t2, t3,t4, fock, g, o, v, e_ai, e_abij, e_abcijk,e_abcdijkl, hf_energy, max_iter=100,
    ...
    t4= np.zeros((nsvirt, nsvirt, nsvirt,nsvirt,nsocc, nsocc, nsocc, nsocc))
    for idx in range(max_iter):

        residual_singles = singles_residual(t1, t2, t3, fock, g, o, v)
        residual_doubles = doubles_residual(t1, t2, t3, fock, g, o, v,e_abij,t4)
...
#        atom='Be 0.0 0.0 0.0',
    ...
    molecule = of.MolecularData(geometry=[['H', (0, 0, 0)], ['F', (0, 0, 0.917)]],
    ...
    e_abcdijkl=1.0/(-eps[v,n,n,n,n,n,n,n]-eps[n,v,n,n,n,n,n,n]-eps[n,n,v,n,n,n,n,n]-eps[n,n,n,v,n,n,n,n]+eps[n,n,n,n,o,n,n,n]+eps[n,n,n,n,n,o,n,n]+eps[n,n,n,n,n,n,o,n]+eps[n,n,n,n,n,n,n,o])
    ...
    t1f, t2f, t3f,t4f = kernel(t1z, t2z, t3z,t4z, fock, g, o, v, e_ai, e_abij,e_abcijk,e_abcdijkl,hf_energy,
                        stopping_eps=1e-10)

    print(flush=True)
    en = cc_energy(t1f, t2f, fock, g, o, v) 
    print("")
    print("    CCSDTQ-1 Correlation Energy: {: 20.12f}".format(en - hf_energy))
    print("    CCSDTQ-1 Total Energy:       {: 20.12f}".format(en + molecule.nuclear_repulsion))
    print("")
    print(flush=True)

    l2=t2f.transpose(2,3,0,1)
    print('shape of l2, t4f,g:', l2.shape,t4f.shape,g.shape)
    e_Qf=Qf.Qf_corr(l2,t4f,g,o,v)
    ...
    print('CCSDTQ-1 total correlation energy: ', en - hf_energy + e_Qf)
    print(flush=True)

    print('Final CCSDTQ-1 energy:', en+molecule.nuclear_repulsion+ e_Qf)
